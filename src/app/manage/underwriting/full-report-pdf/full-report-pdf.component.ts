...
@Component({
  selector: 'ngx-full-report-pdf',
  templateUrl: './full-report-pdf.component.html',
  styleUrls: ['./full-report-pdf.component.scss']
})
export class FullReportPdfComponent implements OnInit {
